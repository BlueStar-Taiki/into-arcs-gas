...
var APP_CONFIG = Object.freeze({
  ...
  FORM_CHOICE: Object.freeze({
    LEGACY_DATE_FORMAT: 'yyyy/MM/dd HH:mm',
    TITLE_PREFIX: '「',
    TITLE_SUFFIX: '」',
    REMAINING_PREFIX: '【残り',
    REMAINING_SUFFIX: '人】',
  ...
  TIME_FORMAT: 'HH:mm',
  JAPANESE_WEEKDAYS: Object.freeze(['日', '月', '火', '水', '木', '金', '土']),
